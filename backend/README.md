...
## Project Structure
    ...
    ├── figmatestingapp_dev_25992  # Django project configurations
...
1. Clone this repo and `cd figmatestingapp_dev_25992`
...
2. Clone this repo and `cd figmatestingapp_dev_25992`
